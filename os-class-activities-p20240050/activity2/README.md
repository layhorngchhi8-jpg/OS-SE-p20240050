...
Parent process (PID: 3948) — creating child...
Parent: waiting for child (PID: 3949) to finish...
...
4. **In Task Manager, what was the PID of your parent program and the PID of mspaint? Do they match your program's output?**
   ...
   > The parent process (winprocess.exe) had PID 11500 and mspaint had PID 18488. Yes, these match exactly what the program printed in the terminal.
...
### Output
```
Consumer: reading from shared memory 'OS-layhorng'
...
### Output
```
Receiver: message received from queue '/queue-layhorng'
